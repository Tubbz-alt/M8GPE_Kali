...
KERN_CONFIG="m8gpekali_defconfig"
KERN_BUILDVER="1.4"
KERN_STRING="Kali M8 GPE"
KERN_AUTHOR="Lavanoid"
KERN_ANDROIDVER="marshmallow"
KERN_ANDROIDVNO="6.0 Marshmallow"
KALI_DEVNAME="onem8gpe"
BUILD_CORES="2"
NH_DEVDIR="kali-nethunter/nethunter-installer/devices"
KERNEL_GIT="https://github.com/lavanoid/android_kernel_htc_m8gpe.git -b android-6.0"
